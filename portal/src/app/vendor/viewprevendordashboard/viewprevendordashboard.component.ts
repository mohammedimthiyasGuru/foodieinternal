...
@Component({
  selector: 'app-viewprevendordashboard',
  templateUrl: './viewprevendordashboard.component.html',
  styleUrls: ['./viewprevendordashboard.component.scss'],
})
export class ViewprevendordashboardComponent implements OnInit {
