...
@Component({
  selector: 'app-merch-dashboad',
  templateUrl: './merch-dashboad.component.html',
  styleUrls: ['./merch-dashboad.component.scss'],
})
export class MerchDashboadComponent implements OnInit {
  ...
  action1(){
    this.router.navigateByUrl('/merchant_panel/golive/'+this.profile.profile_id);
  }
