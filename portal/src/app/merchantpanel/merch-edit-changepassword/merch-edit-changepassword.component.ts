...
@Component({
  selector: 'app-merch-edit-changepassword',
  templateUrl: './merch-edit-changepassword.component.html',
  styleUrls: ['./merch-edit-changepassword.component.scss'],
})
export class MerchEditChangepasswordComponent implements OnInit {
