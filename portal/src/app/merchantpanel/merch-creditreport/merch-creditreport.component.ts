...
@Component({
  selector: 'app-merch-creditreport',
  templateUrl: './merch-creditreport.component.html',
  styleUrls: ['./merch-creditreport.component.scss'],
  providers: [DatePipe]
})
export class MerchCreditreportComponent implements OnInit {
