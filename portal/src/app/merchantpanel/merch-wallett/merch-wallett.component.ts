...
@Component({
  selector: 'app-merch-wallett',
  templateUrl: './merch-wallett.component.html',
  styleUrls: ['./merch-wallett.component.scss'],
  providers: [DatePipe]
})
export class MerchWallettComponent implements OnInit {
