...
@Component({
  selector: 'app-merch-edit-bussiness',
  templateUrl: './merch-edit-bussiness.component.html',
  styleUrls: ['./merch-edit-bussiness.component.scss'],
})
export class MerchEditBussinessComponent implements OnInit {
