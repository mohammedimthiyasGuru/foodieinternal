...
@Component({
  selector: 'app-merch-debitreport',
  templateUrl: './merch-debitreport.component.html',
  styleUrls: ['./merch-debitreport.component.scss'],
  providers: [DatePipe]
})
export class MerchDebitreportComponent implements OnInit {
