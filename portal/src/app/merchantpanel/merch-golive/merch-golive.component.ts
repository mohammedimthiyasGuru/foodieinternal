...
@Component({
  selector: 'app-merch-golive',
  templateUrl: './merch-golive.component.html',
  styleUrls: ['./merch-golive.component.scss'],
})
export class MerchGoliveComponent implements OnInit {
...
add_video(){
  this.router.navigateByUrl('/merchant_panel/merch_video_add/'+this._profileId);
}
