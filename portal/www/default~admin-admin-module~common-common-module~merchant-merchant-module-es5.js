(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~admin-admin-module~common-common-module~merchant-merchant-module"], {
    ...
    /***/
    function U3K(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MasterasidePage", function () {
        return MasterasidePage;
      });
      /* harmony import */
      ...
      var _raw_loader_masteraside_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./masteraside.page.html */
      "fSls");
      /* harmony import */


      var _masteraside_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./masteraside.page.scss */
      "kjK3");
      /* harmony import */
      ...
      var src_app_core_data_localstorage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var MasterasidePage = /*#__PURE__*/function () {
        function MasterasidePage(storage, router, route) {
          _classCallCheck(this, MasterasidePage);

          this.storage = storage;
          this.router = router;
          this.route = route;
          var temp = this.storage.menu_setting; //  this.storage.menu_setting = true;

          this.sidemenu = temp.status;
          console.log(this.sidemenu);
        }

        _createClass(MasterasidePage, [{
          key: "ngOnInit",
          ...
          key: "menu_action",
          value: function menu_action(data) {
            console.log(data);
            console.log(this.sidemenu);

            if (data == 'small') {
              this.storage.menu_setting = {
                status: true
              };
              this.sidemenu = true;
            } else if (data == 'big') {
          ...
          key: "action1",
          value: function action1() {
            this.router.navigateByUrl('/dashboard');
          }
        }, {
          key: "action2",
          value: function action2() {
            this.router.navigateByUrl('/vendor/dashboard');
          }
        }, {
          key: "action3",
          value: function action3() {
            this.router.navigateByUrl('/admin/dashboard');
          }
        }, {
          key: "action4",
          value: function action4() {
            this.router.navigateByUrl('/merchant/updateorderstatus');
          }
        }, {
          key: "action5",
          value: function action5() {
            this.router.navigateByUrl('/loginpage');
          }
        }, {
          key: "action6",
          value: function action6() {
            this.router.navigateByUrl('/loginpage');
          }
        }, {
          key: "action7",
          value: function action7() {
            this.router.navigateByUrl('/loginpage');
          }
        }, {
          key: "action8",
          value: function action8() {
            this.router.navigateByUrl('/loginpage');
          }
        }]);
      ...
      MasterasidePage.ctorParameters = function () {
        return [{
      ...
      MasterasidePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function D0T(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function DYjj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function JlfY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MasterfooterPage", function () {
        return MasterfooterPage;
      });
      /* harmony import */
      ...
      var _raw_loader_masterfooter_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./masterfooter.page.html */
      "q17p");
      /* harmony import */


      var _masterfooter_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./masterfooter.page.scss */
      "kQUy");
      /* harmony import */
      ...
      var MasterfooterPage = /*#__PURE__*/function () {
        function MasterfooterPage(storage) {
          _classCallCheck(this, MasterfooterPage);

          this.storage = storage;
        }

        _createClass(MasterfooterPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.currentUser = this.storage.user;
          }
      ...
      MasterfooterPage.ctorParameters = function () {
        return [{
          type: src_app_core_data_localstorage__WEBPACK_IMPORTED_MODULE_4__["LocalStorage"]
        }];
      };

      MasterfooterPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function Mmwu(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MasterlayoutPage", function () {
        return MasterlayoutPage;
      });
      /* harmony import */
      ...
      var _raw_loader_masterlayout_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./masterlayout.page.html */
      "DYjj");
      /* harmony import */


      var _masterlayout_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./masterlayout.page.scss */
      "b1QE");
      /* harmony import */
      ...
      var MasterlayoutPage = /*#__PURE__*/function () {
        function MasterlayoutPage() {
          _classCallCheck(this, MasterlayoutPage);
        }

        _createClass(MasterlayoutPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }]);
      ...
      MasterlayoutPage.ctorParameters = function () {
        return [];
      };

      MasterlayoutPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function OZ2c(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MasterheaderPage", function () {
        return MasterheaderPage;
      });
      /* harmony import */
      ...
      var _raw_loader_masterheader_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./masterheader.page.html */
      "D0/t");
      /* harmony import */


      var _masterheader_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./masterheader.page.scss */
      "RZRh");
      /* harmony import */
      ...
      var src_app_core_services_profile_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! src/app/_core/services/profile.service */
      "JYRz");
      /* harmony import */


      var src_app_core_data_localstorage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/_core/_data/localstorage */
      "Q8Vt");
      /* harmony import */
      ...
      var MasterheaderPage = /*#__PURE__*/function () {
        function MasterheaderPage(storage, profileservice, route, router) {
          _classCallCheck(this, MasterheaderPage);
        ...
        _createClass(MasterheaderPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this = this;

            this.currentUser = this.storage.user;
            this.profileservice.profile_view(this.currentUser.profile_id).subscribe(function (res) {
              console.log(res);
              _this.user_name = res.profile_biz_name;
            ...
            if (this.currentUser.role_id == 2) {
              this.user_type = 'Merchant'; // this.user_name = this.currentUser.user_name;

              this.user_img = this.currentUser.profile_img;
            } else if (this.currentUser.role_id == 3) {
              this.user_type = 'Vendor'; // this.user_name = this.currentUser.user_name;

              this.user_img = this.currentUser.profile_img;
            } else if (this.currentUser.role_id == 1) {
              this.user_type = 'Admin'; // this.user_name = this.currentUser.user_name;
          ...
          key: "edit_bussnes_info",
          value: function edit_bussnes_info() {
            var res = {
              profile_id: this.profile_details.profile_id,
              user_id: this.profile_details.user.user_id,
              email: this.profile_details.user.user_login
            };
      ...
      MasterheaderPage.ctorParameters = function () {
        return [{
      ...
      MasterheaderPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function b1QE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function fSls(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function kQUy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function kjK3(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function q17p(module, __webpack_exports__, __webpack_require__) {
      "use strict";
